...
import 'package:vehicle_no_assignment/data/sources/remote/apis.dart';
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          //
          //     return vehicleModel.type == 'Bike' ? Container() : Card(
          //       child: Column(
          //         children: [
          //           ListTile(
                    ...
                    children: [
                      ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            Text('Car No : ${vehicleModel.vehicleno}'),
